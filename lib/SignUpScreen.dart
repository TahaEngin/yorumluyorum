      ...
      body: Center(
        ...
        child: SingleChildScrollView(
          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
            Temp_TextState(
                Icons.mail_outline, "Yetkili Maili", controllert, false, false),
            Temp_TextState(
                Icons.person, "İsim Soyisim", controlleri, false, false),
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    print(controlleri.text);
                    print(controllerc2.text);
                  },
                ),
              ),
            ),
